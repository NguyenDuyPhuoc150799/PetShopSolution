        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2021, 8, 28, 23, 20, 3, 667, DateTimeKind.Local).AddTicks(7592)),
                    UserId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "HomeTitle", "This is home page of PetShopSolution" },
                    { "HomeKeyword", "This is keyword of PetShopSolution" },
                    { "HomeDescription", "This is description of PetShopSolution" }
                });

            migrationBuilder.InsertData(
                table: "AppRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "Name", "NormalizedName" },
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "9e78d584-e977-4a5f-9fb9-19ce00ce9018", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "18676375-d168-4809-bc8b-a4a3ec1610a4", new DateTime(2020, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "phuocnt150799@gmail.com", true, "Phuoc", "Nguyen", false, null, "phuocnt150799@gmail.com", "admin", "AQAAAAEAACcQAAAAEOrG9CbuD8iKsRsutw2xESk0S+Om5aZN0Xzv7J0hBY8wHss6SVzTg6v4DM1nHRuRkg==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 8, 28, 23, 20, 3, 685, DateTimeKind.Local).AddTicks(7002), 100000m, 200000m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "vi-VN", "Chó", "cho", "Sản phẩm cho chó", "Sản phẩm cho chó" },
                    { 3, 2, "vi-VN", "Mèo", "meo", "Sản phẩm cho mèo", "Sản phẩm cho mèo" },
                    { 2, 1, "en-US", "Dog", "dog", "Products for dog", "Products for dog" },
                    { 4, 2, "en-US", "Cat", "cat", "Products for cat", "Products for cat" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Áo thun bestie", "Áo thun bestie", "vi-VN", "Áo thun bestie", 1, "ao-thun-bestie", "Áo thun bestie", "Áo thun bestie" },
                    { 2, "Bestie T-Shirt", "Bestie T-Shirt", "en-US", "Bestie T-Shirt", 1, "bestie -t-shirt", "Bestie T-Shirt", "Bestie T-Shirt" }
                });
