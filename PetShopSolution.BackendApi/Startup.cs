...
namespace PetShopSolution.BackendApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PetShopDbContext>(options =>
             options.UseSqlServer(Configuration.GetConnectionString("PetShopSolutionDb")));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Swagger PetShop Solution", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Swagger PetShopSolution V1");
            });
